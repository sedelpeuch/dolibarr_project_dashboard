...
# Cache for thirdparty data
_thirdparty_cache: dict = {}


def get_thirdparty_name(client_id: int) -> dict:
...
def get_dashboard():
    ...
    """
    try:
        # Get list of projects to track from data.json (reload each time)
        data = load_data()
